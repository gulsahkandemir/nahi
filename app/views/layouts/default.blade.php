...
<html lang="en">
    <head>
        ...
        <meta property="twitter:image" content="http://needahand.in/images/nahi-og-image.png"/>

        <meta property="og:image" content="http://needahand.in/images/nahi-og-image.png"/>
        ...
        <meta property="og:description" content="We're helping your friends to help you.
                ...
                Or do you simply want one of your handy friends to help fix your sink?
                Just ask for hand using 'Need a Hand'."/>
        <meta property="og:url" content="http://needahand.in"/>
